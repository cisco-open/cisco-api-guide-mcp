...
The `cisco-api-guide-mcp` maintainers take all security issues in the project
seriously. Thank you for improving the security of `cisco-api-guide-mcp`. We
appreciate your dedication to responsible disclosure and will make every effort
to acknowledge your contributions.

`cisco-api-guide-mcp` leverages GitHub's private vulnerability reporting.
